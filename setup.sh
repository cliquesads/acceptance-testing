...
usage="$(basename "$0") -- Sets up all global packages necessary to deploy the acceptance testing, including Node, PM2 & Redis using environment set in config/adexchange.cfg.
